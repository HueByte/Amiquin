...
EXAMPLES:
    ./docfx.sh                          # Build documentation
    ./docfx.sh serve                    # Build and serve on default port
    ./docfx.sh serve --port 3000        # Build and serve on port 3000
    ./docfx.sh clean                    # Clean generated files
    ./docfx.sh build --force --verbose  # Force rebuild with verbose output
...
print_info "📚 Amiquin DocFX Runner"
print_info "======================="
echo
