...
/// <summary>
/// Context information parsed from a modal's custom ID.
/// </summary>
public class ModalContext
{
    ...
    public ModalContext(string prefix, string[] parameters, string originalCustomId)
    {
        Prefix = prefix;
