...
public class ConversationCoreService : IConversationCoreService
{
    ...
    /// </summary>
    public ConversationCoreService(ILogger<ConversationCoreService> logger, IMessageManager messageManager, ChatClient openAIClient, ISemaphoreManager chatSemaphoreManager)
    {
        _logger = logger;
    ...
    {
        var personaMessage = await _messageManager.GetPersonaCoreMessageAsync();
